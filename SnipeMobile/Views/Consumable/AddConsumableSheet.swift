...
struct AddConsumableSheet: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(L10n.string("new_consumable"))
    ...
    private var generalSection: some View {
        Section(L10n.string("general")) {
            ...
            TextField(L10n.string("item_no_optional"), text: $itemNo)
    ...
    private func create() async {
        ...
        let result = await apiClient.createConsumable(
            name: trimmedName,
        ...
        resultMessage = result.success
            ? L10n.string("consumable_created")
